            ...
            <div class="container-fluid">
                ...
                <div class="card border border-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="basic_livelihood_SLG_training_reports_filter2.php" method ="POST" >
                    ...
                    <div class="col-12">
                        ...
                        <h7 class="card-title mt-0"></h7>
                                ...
                                <table id="datatable-buttons" class="table table-bordered dt-responsive  nowrap w-100">
                                    ...
                                    <tbody>
                                        <?Php
                                            $query="select distinct tblgroup.groupname,tblgroup.cohort,tblgroup.districtID, tblgroup.groupID from tblgrouptrainings inner join tblgroup on tblgrouptrainings.groupID = tblgroup.groupID where tblgroup.regionID = '$region';";
