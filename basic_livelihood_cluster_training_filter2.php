                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="basic_livelihood_cluster_training_filter3.php" method ="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="card border border-primary">
                                                        <h5 class="my-0 text-default">SL Clusters in District: <?php echo dis_name($link,$district);?></h5>
                                                    <div class="card-body">
