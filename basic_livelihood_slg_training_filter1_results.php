                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border border-primary">
                                                <div class="card-header bg-transparent border-primary">
                                                    <h5 class="my-0 text-primary"></i>SLG Training Search Filter For :<?php echo get_rname($link,$region); ?> Region</h5>
                                                </div>
                                                <div class="card-body">
                                                    <h5 class="card-title mt-0"></h5>
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="basic_livelihood_slg_training_filter2_results.php" method ="GET">
                                                        <div class="col-12">
