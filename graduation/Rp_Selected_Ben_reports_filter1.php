                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="graduationReports.php">Graduation Livelihood Reports</a></li>
                            ...
                            <div class="card-body">
                                <div class="card border border-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="Rp_Selected_Ben_reports_filter2.php" method ="POST" >
                                            ...
                                            <table id="datatable-buttons" class="table table-bordered dt-responsive  nowrap w-100">
                                                ...
                                                <tbody>
                                                    <?Php
                                                        ...
                                                        $query="SELECT sppCode, hh_head_name, districtID, groupID, spProg FROM tblbeneficiaries where ((grad_status = '1') and (regionID = '$region'))";
