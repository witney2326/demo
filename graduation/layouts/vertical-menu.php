    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <li>
                <li>
                    <a href="javascript: void(0);" class="waves-effect">
                        <i class="bx bx-dollar-circle"></i><span class="badge rounded-pill bg-info float-end"></span>
                        <span key="t-dashboards">Livelihood Interventions</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="true">
                        <li>
                            <?php if ($_SESSION["user_role"] == '00'){echo '<a href="javascript: void(0);" class="has-arrow waves-effect" key="t-vertical">Basic-Livelihood </a>' ;}else{echo '<a href="../basic_livelihood.php" class="has-arrow waves-effect" key="t-vertical">Basic-Livelihood</a>';}  ?>
                        </li>
                        <li>
                            <?php if ($_SESSION["user_role"] == '00'){echo '<a href="javascript: void(0);" class="has-arrow" key="t-horizontal">Enhanced-Livelihood</a>' ;}else{echo '<a href="../enhanced_livelihood/enhanced_livelihood.php" class="has-arrow" key="t-horizontal">Enhanced-Livelihood</a>';}  ?>
                        </li>
                        <li>
                            <?php if ($_SESSION["user_role"] == '00'){echo '<a href="javascript: void(0);" class="has-arrow" key="t-horizontal">Graduation</a>' ;}else{echo '<a href="../graduation/graduation.php" class="has-arrow" key="t-horizontal">Graduation</a>';}  ?>
                        </li>
                        <li>
                            <a href="javascript: void(0);" class="has-arrow" key="t-horizontal">CS-EPWP</a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li>
                                    <?php if ($_SESSION["user_role"] == '00'){echo '<a href="javascript: void(0);" class="has-arrow waves-effect" key="t-vertical">Basic-Livelihood </a>' ;}else{echo '<a href="../csepwp/csepwp_basic_livelihood.php" class="has-arrow waves-effect" key="t-vertical">Basic-Livelihood</a>';}  ?>
                                </li>
                                <li>
                                    <?php if ($_SESSION["user_role"] == '00'){echo '<a href="javascript: void(0);" class="has-arrow" key="t-horizontal">Enhanced-Livelihood</a>' ;}else{echo '<a href="../csepwpel/csepwp_enhanced_livelihood.php" class="has-arrow" key="t-horizontal">Enhanced-Livelihood</a>';}  ?>
                                </li>
                                <li>
                                    <?php if ($_SESSION["user_role"] == '00'){echo '<a href="javascript: void(0);" class="has-arrow" key="t-horizontal">Graduation</a>' ;}else{echo '<a href="../csepwpgr/graduation.php" class="has-arrow" key="t-horizontal">Graduation</a>';}  ?>
                                </li>  
