                                ...
                                <!-- Tab panes -->
                                            ...
                                            <div class="card border border-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="graduation_selected_groups_filter2.php" method="POST">
                                                            ...
                                                            <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                                ...
                                                                <tbody>
                                                                    <?Php
                                                                        ...
                                                                        $query="select * from tblgroup where ((grad_status ='1') and (regionID = '$region'))";
                                                                        ...
                                                                        $query="select * from tblcluster where ((grad_status ='1') and (regionID = '$region'))";
