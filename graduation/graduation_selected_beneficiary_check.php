...
<?php
 include '../layouts/session.php';
    ...
    if (($_SESSION["user_role"]== '05')) {
        header("location: graduation_selected_beneficiary_filter2.php");   
    }
    if (($_SESSION["user_role"]== '04')) {
        header("location: graduation_selected_beneficiary_filter2.php");   
    }
    if (($_SESSION["user_role"]== '03')) {
        header("location: graduation_selected_beneficiary_filter1.php");   
    }

    if (($_SESSION["user_role"]== '02')) {
        header("location: graduation_selected_beneficiary.php");   
    }
