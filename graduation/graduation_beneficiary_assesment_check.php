...
<?php
 include '../layouts/session.php';
    ...
    if (($_SESSION["user_role"]== '05')) {
        header("location: graduation_beneficiary_assesment_filter2.php");   
    }
    if (($_SESSION["user_role"]== '04')) {
        header("location: graduation_beneficiary_assesment_filter2.php");   
    }
    if (($_SESSION["user_role"]== '03')) {
        header("location: graduation_beneficiary_assesment_filter1.php");   
    }

    if (($_SESSION["user_role"]== '02')) {
        header("location: graduation_beneficiary_assesment.php");   
    }
