...
<?php 
    ...
    function get_rname($link, $rcode)
        ...
        function meeeting_purpose($link, $ID)
        {
        $purp_query = mysqli_query($link,"select purpose from tblmeetingpurpose where id='$ID'"); // select query
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-9">
                            <div class="card border border-success">
                                ...
                                <h5 class="my-0 text-primary"> New Graduation Meeting in <?php echo dis_name($link,$district); ?></h5>
                                </div>
                                <div class="card-body">
