...
<?php
 include '../layouts/session.php';
    ...
    if (($_SESSION["user_role"]== '05')) {
        header("location: graduation_grp_assesment_filter3.php");   
    }
    if (($_SESSION["user_role"]== '04')) {
        header("location: graduation_group_assesment.php");   
    }
    if (($_SESSION["user_role"]== '03')) {
        header("location: graduation_grp_assesment_filter1.php");   
    }
