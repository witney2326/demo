                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Graduation Selected Households</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="graduationReports.php">Graduation Reports</a></li>
                                    <li class="breadcrumb-item active">Graduation Reports</li>
                                </ol>
                            </div>
                                ...
                                <div class="card border border-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="" method ="GET" >
                                            ...
                                            <div class="col-12">
                                                <button type="submit" class="btn btn-primary w-md" style="width:120px" name="Submit" value="Submit">Submit</button>
                                ...
                                <div class="card border border-primary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="datatable-buttons" class="table table-bordered dt-responsive  nowrap w-100">
                                                ...
                                                <tbody>
                                                    <?Php
                                                        $query="SELECT tblbeneficiaries.sppCode, tblbeneficiaries.hh_head_name, tblbeneficiaries.districtID, tblbeneficiaries.groupID, tblbeneficiaries.spProg FROM tblbeneficiaries 
                                                        inner join tblgroup on tblbeneficiaries.groupID = tblgroup.groupID inner join
                                                        tblcw on tblgroup.cwID = tblcw.cwID where ((tblbeneficiaries.grad_status = '1') and (tblgroup.cwID = '$cw'));";
                                                        ...
                                                        { 
                                                            ...
                                                            $program = spp_name($link,$row["spProg"]);
