                            ...
                            <div class="card-body">
                                <div class="card border border-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="Rp_Selected_SLG_reports_filter3.php" method ="POST" >
                                            ...
                                            <table id="datatable-buttons" class="table table-bordered dt-responsive  nowrap w-100">
                                                ...
                                                <tbody>
                                                    <?Php
                                                        ...
                                                        FROM tblgroup 
                                                        INNER JOIN tblcw on tblcw.cwID = tblgroup.cwID where ((tblgroup.DistrictID ='$district') and (tblgroup.grad_status = '1'))";
