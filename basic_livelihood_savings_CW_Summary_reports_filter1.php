                            ...
                            <div class="card-body">
                                ...
                                <div class="card border border-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="basic_livelihood_savings_CW_Summary_reports_filter2.php" method ="GET" >
                                            <div class="col-12">
                                            ...
                                            <table id="datatable-buttons" class="table table-bordered dt-responsive  nowrap w-100">
                                                ...
                                                <tbody>
                                                    <?Php
                                                        ...
                                                        inner join tblgroupsavings on tblgroup.groupID = tblgroupsavings.GroupID where tblgroup.regionID ='$region'
