                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Edit Group Record</h4>
                            <div class="page-title-right">
                                    ...
                                    <button type="button" class="btn btn-primary">
                                      <a style="color: white;" href="group_records.php?id=<?php echo $_SESSION["id"]; ?>">Back</a>
                                    </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-12">
                                                            ...
                                                            <?php
                                                                ...
                                                                if (isset($_POST['edit'])) {
                                                                    ...
                                                                    $sql21 = "UPDATE tblgrouprecords SET record_id='$record_id' WHERE id='$id'";
                                                                        ...
                                                                        if ($result21 == TRUE) {
                                                                            $groupid = $_SESSION["id"];
                                                                            $baseUrl = "group_records.php?id=".$groupid;
                                                                ...
                                                                if (isset($_GET['id'])) {
                                                                    $id = $_GET['id'];
                                                                    $sql = "SELECT * FROM tblgrouprecords WHERE id = $id";
                                                            ...
                                                            <input value="<?php echo $id ?>" type="hidden" name="id" />
                                                                ...
                                                                <option value="<?php echo $row20["id"] ?>" <?php if($row20['id'] == $record_id) { ?> selected="selected"<?php } ?>>
