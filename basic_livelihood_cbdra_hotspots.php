                                        ...
                                        <p class="mb-0">
                                            <div class="card border border-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="basic_livelihood_cbdra_hotspots_filter1.php" method ="GET" >
                                                        <div class="col-12">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <input class="text" name="hotspot" id="hotspot" required disabled> 
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <select class="form-select" name="issue" id="issue" required disabled>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <select class="form-select" name="chance" id="chance" required disabled>
