                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">BDS Identification</h4>
                            ...
                            <div class="card border border-success">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="jsg_TrainingPlan.php">
                                        <div class="row mb-1">
                                            <label for="group_id" class="col-sm-2 col-form-label">JSG ID</label>
                                        ...
                                        <div class="row mb-2">
                                            <?php 
                                                function Buscat1_name($link_cs, $catID)
                                                {
                                                    $BusCat_query = mysqli_query($link_cs,"select catname from tblbusines_category where categoryID='$catID'"); // select query
                                                    $BusCat = mysqli_fetch_array($BusCat_query);// fetch data
                                                    return $BusCat['catname'];
                                            ...
                                            <select class="form-select" name="buscat" id="buscat" style="max-width:30%;" required>
                                                <option selected value="<?php echo $bus_category;?>"><?php echo Buscat1_name($link_cs,$bus_category);?></option>
                                            </select>
                                            ...
                                            <select class="form-select" name="bustype" id="bustype" style="max-width:25%;" required>
                                                <option selected value="<?php echo $type;?>"><?php echo BusType_name($link_cs,$type);?></option>
                                        ...
                                        <div class="row mb-4">
                                            <label for="bds" class="col-sm-2 col-form-label"> BDS</label>
                                        ...
                                        <div class="row mb-4"><h6 class="my-0 text-primary">Allocate and Schedule BDS</h6></div>
                                        <div class="row mb-4">
