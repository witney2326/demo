                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="card-header bg-transparent border-primary">
                                                        <h5 class="my-0 text-primary">Trained JSGs in TA: <?php echo ta_name($link_cs,$ta); ?></h5>
                                                    </div>
                                                    <div class="card-body">
                                                    <h7 class="card-title mt-0"></h7>
                                                            ...
                                                            <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                                ...
                                                                <tbody>
                                                                    <?Php
                                                                        $query="select * from tbljsg_trainings inner join tblgroup on tbljsg_trainings.groupID = tblgroup.groupID where tblgroup.TAID = '$ta'";
