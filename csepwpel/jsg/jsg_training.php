...
<head>
    <title>JSG|Training Management</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">JSG Training Management</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="jsg.php">JSG Dashboard</a></li>
                                    <li class="breadcrumb-item active">JSG Training Management</li>
                                </ol>
                            </div>
                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border border-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="jsg_training_filter1.php" method ="POST" >
                                                        <div class="col-12">
                                                            ...
                                                            <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                                ...
                                                                <tbody>
                                                                    <?Php
                                                                        ...
                                                                        { 
                                                                            $rec = $row["recID"];
                                                                            $result = mysqli_query($link_cs, "SELECT count(jsgID) AS TRs FROM tbljsg_trainings 
                                                                            where jsgID = '$rec'"); 
