...
<?php  
    ...
    function get_rname($link_cs, $rcode)
        ...
        function grp_name($link_cs, $code)
        {
        $grp_query = mysqli_query($link_cs,"select ClusterName from tblcluster where ClusterID='$code'"); // select query
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <!-- end page title -->
                                ...
                                <li class="nav-item waves-effect waves-light">
                                    <a class="nav-link" data-bs-toggle="link" href="jsgs_clusters_check.php" role="link">
                                        <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <h7 class="card-title mt-0"></h7>
                                                            ...
                                                            <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                                ...
                                                                <tbody>
                                                                    <?Php
                                                                        $query="select * from tbljsg inner join tblgroup on tbljsg.groupID = tblgroup.groupID where ((tblgroup.TAID = '$ta') and (tbljsg.deleted ='0'))";
