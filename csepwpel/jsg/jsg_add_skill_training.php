...
if ($result_set = $link_cs->query($q2)) {
                                            ...
                                            <form method="POST" action="jsg_training_add1.php">
                                                ...
                                                <div class="row mb-1">
                                                    ...
                                                    <select class="form-select" name="trainingtype" id="trainingtype" style="max-width:30%;" required>
                                                        <option selected value="<?php echo $bustype;?>"><?php echo iga_name($link_cs,$bustype);?></option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="row mb-1">
                                                    ...
                                                    <select class="form-select" name="trainedby" id="trainedby" style="max-width:30%;" required>
                                                        <option selected value="<?php echo $bds;?>"><?php echo bdsname($link_cs,$bds)?></option>
                                                    </select>
                                                </div>
