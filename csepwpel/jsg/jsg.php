                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">CS-EPWP Joint Skill Groups</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="../csepwp_enhanced_livelihood.php">Enhanced Livelihood</a></li>
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div class="d-flex">
                                                                                <div class="flex-grow-1">
                                                                                    ...
                                                                                    if ($user == "05")
                                                                                    {
                                                                                        $result = mysqli_query($link_cs, "SELECT sum(no_male) AS total_males FROM tbljsg inner join tblgroup on
                                                                                        tbljsg.groupID = tblgroup.groupID where tblgroup.TAID = '$ta'"); 
                                                                                        $row = mysqli_fetch_assoc($result); 
                                                                                        $total_males = $row['total_males'];
                                                                                        
                                                                                        $result2 = mysqli_query($link_cs, "SELECT sum(no_female) AS total_females FROM tbljsg inner join tblgroup on
                                                                                        tbljsg.groupID = tblgroup.groupID where tblgroup.TAID = '$ta'"); 
                                                                                    ...
                                                                                    {
                                                                                        $result = mysqli_query($link_cs, 'SELECT sum(no_male) AS total_males FROM tbljsg'); 
                                                                                        $row = mysqli_fetch_assoc($result); 
                                                                                        $total_males = $row['total_males'];
                                                                                        
                                                                                        $result2 = mysqli_query($link_cs, 'SELECT sum(no_female) AS total_females FROM tbljsg'); 
                                                                                        $row2 = mysqli_fetch_assoc($result2); 
                                                                                        $total_females = $row2['total_females'];
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="d-flex">
                                                                        <div class="flex-grow-1">
                                                                            ...
                                                                            if ($user == "05")
                                                                            {
                                                                                $result = mysqli_query($link_cs, "SELECT COUNT(recID) AS total_jsgs FROM tbljsg inner join tblgroup on
                                                                                tbljsg.groupID = tblgroup.groupID where tblgroup.TAID = '$ta'"); 
                                                                                $row = mysqli_fetch_assoc($result); 
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="d-flex">
                                                                        <div class="flex-grow-1">
                                                                            ...
                                                                            <?php
                                                                                        $result = mysqli_query($link_cs, 'SELECT COUNT(bdsID) AS total_bdss FROM tblbds'); 
                                                                                        $row = mysqli_fetch_assoc($result); 
