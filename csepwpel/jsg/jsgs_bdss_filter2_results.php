                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="card-header bg-transparent border-primary">
                                                        <h5 class="my-0 text-primary">Available Busines Development Services in <?php echo dis_name($link_cs,$district); ?></h5>
                                                    </div>
                                                    <div class="card-body">
                                                            ...
                                                            <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                                ...
                                                                <tbody>
                                                                    <?Php
                                                                        ...
                                                                        $query="select * from tblbds where districtID ='$district'";
