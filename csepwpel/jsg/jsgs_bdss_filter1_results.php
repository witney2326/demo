                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">BDS: Available BDS</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-pills nav-justified" role="tablist"> 
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" data-bs-toggle="tab" href="jsgs_bds_check.php" role="link">
                                            <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border border-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="jsgs_bdss_filter2_results.php" method ="POST">
                                                        <div class="col-12">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <h5 class="card-title mt-0"></h5>
                                                            ...
                                                            <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                                ...
                                                                <tbody>
                                                                    <?Php
                                                                        $query="select * from tblbds where regionID='$region'";
                                                                    ...
                                                                    { 
                                                                        ...
                                                                        $buscat = bus_cat_name($link_cs,$row["busCat"]);
                                                                        echo "<tr>\n";
