                    ...
                    <div class="col-xl-12">    
                        <div class="card border border-primary">
                            ...
                            <div class="card-body">
                                ...
                                <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="jsg_training_trained_groups_filter3.php" method ="POST" >
                                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-header bg-transparent border-primary">
                            <h5 class="my-0 text-primary">Trained JSGs in <?php echo dis_name($link_cs,$district); ?></h5>
                        </div>
                        <div class="card-body">
                        <h7 class="card-title mt-0"></h7>
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                    ...
                                    <tbody>
                                        <?Php
                                            $query="select * from tbljsg_trainings inner join tblgroup on tbljsg_trainings.groupID = tblgroup.groupID where tblgroup.districtID = '$district'";
                                            ...
                                            if ($result_set = $link_cs->query($query)) {
                                                ...
                                                { 
                                                    $groupname = jsg_name($link_cs,$row["jsgID"]);
                                                    ...
                                                    echo "<tr>\n";
                                                        ...
                                                        echo "<td>".jsg_name($link_cs,$row["jsgID"])."</td>\n";
