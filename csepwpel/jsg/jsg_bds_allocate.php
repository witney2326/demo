                        ...
                        <div class="col-lg-9">
                            <div class="card border border-success">
                                <div class="card-header bg-transparent border-success">
                                    <h6 class="my-0 text-primary">Update Training Record For SLG:<?php echo" ". $groupname; ?><?php echo ";"." "." "."Group ID:-"; echo " "; echo $id; echo ";"." "." "."District:-"; echo " "; echo dis_name($link_cs,$DistrictID) ?></h6>
                                </div>
                                <div class="card-body">
