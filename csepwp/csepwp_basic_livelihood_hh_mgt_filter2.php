            ...
            <div class="container-fluid">
                ...
                <div class="card border border-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="csepwp_basic_livelihood_hh_mgt_filter3.php" method="POST">
                            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-header bg-transparent border-primary">
                            <h5 class="my-0 text-default">Beneficiary Households in <?php echo dis_name($link_cs,$district); ?> District</h5>
                        </div>
                            <div class="card-body">
