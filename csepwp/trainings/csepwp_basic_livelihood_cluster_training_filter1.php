                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Cluster Training Management</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="csepwp_basic_livelihood_cluster_training.php">SLG Training Management</a></li>
                                    <li class="breadcrumb-item active">Cluster Training</li>
                                </ol>
                            </div>
                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="csepwp_basic_livelihood_cluster_training_filter2.php" method ="POST">
                                                        <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="card border border-primary">
                                                        <h5 class="my-0 text-default">SL Clusters in Region: <?php echo get_rname($link_cs,$region);?></h5>
                                                    <div class="card-body">
                                                                    ...
                                                                    <?Php
                                                                        ...
                                                                        if ($result_set = $link_cs->query($query)) {
                                                                            ...
                                                                            { 
                                                                                ...
                                                                                $males = mysqli_query($link_cs, "SELECT SUM(MembersM) AS total_males FROM tblgroup where ClusterID = '$cluster_code'"); 
                                                                                $row_males = mysqli_fetch_assoc($males); 
                                                                                $total_males = $row_males['total_males'];
              
                                                                                $females = mysqli_query($link_cs, "SELECT SUM(MembersF) AS total_females FROM tblgroup where ClusterID = '$cluster_code'"); 
