                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">CS-EPWP Training Management</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="csepwp_basic_livelihood_training_check.php">SLG Training Management</a></li>
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center">
                                                        <div class="col-12">
                                                            ...
                                                            <div>
                                                                <select class="form-select" name="region" id="region" value ="$region" required >
                                                                    <option selected value = "<?php if (isset($region)){echo $region;}else{echo "";}?>"><?php if (isset($region)) {echo get_rname($link_cs,$region);}else{echo "";}?></option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <select class="form-select" name="district" id="district" value ="$district" required>
                                                                <option selected value="<?php if (isset($district)){echo $district;}else{echo "";}?>" ><?php if (isset($district)) {echo dis_name($link_cs,$district);}else{echo "";} ?></option>
