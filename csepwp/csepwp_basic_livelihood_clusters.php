                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="csepwp_basic_livelihood_slg_mgt2.php">SLG Mgt</a></li>
                            ...
                            <ul class="nav nav-pills nav-justified" role="tablist">
                                ...
                                <div class="card border border-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="csepwp_mgt_cls_filter1_results.php" method ="POST" >
                                            <div class="col-12">
                                                    ...
                                                    <tbody>
                                                        <?Php
                                                            ...
                                                            echo "<tr>\n";
                                                                ...
                                                                echo "<td>
                                                                    <a href=\"basicCLSview_csepwp.php?id=".$row['ClusterID']."\"><i class='far fa-eye' title='View Cluster' style='font-size:18px'></i></a>\n";
                                                                    echo
                                                                        "<a href=\"basicCLSedit_csepwp.php?id=".$row['ClusterID']."\"><i class='far fa-edit' title='Edit Cluster Details' style='font-size:18px'></i></a>\n";
                                                                    echo 
