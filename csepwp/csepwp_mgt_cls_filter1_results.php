...
<?php 
  ...
  if ((($_POST['district']) <> '00') and (($_POST['ta']) <> '0000') and ($_SESSION["user_role"] <>'03') and ($_SESSION["user_role"] <>'04') and ($_SESSION["user_role"] <>'05'))  
  {
      ...
      header("location: csepwp_mgt_cls_filter3_results.php");
  } 
                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border border-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="csepwp_mgt_cls_filter2_results.php" method ="POST">
                                                        <div class="col-12">
