                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">CS-EPWP Add New Cluster</h4>
                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border border-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="csepwp_new_cls_filter2_results.php" method ="POST" >
                                                        <div class="col-12">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <select class="form-select" name="ta" id="ta" required >
                                                                <option selected value="">Select TA</option>
                                                            </select>
                                                        </div>
