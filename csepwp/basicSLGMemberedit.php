                ...
                <div class="row">
                    <div class="col-9">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">CS-EPWP Household Edit</h4>
                        ...
                        <div class="col-lg-9">
                            <div class="card border border-success">
                                <div class="card-header bg-transparent border-success">
                                    <h5 class="my-0 text-success"> Edit Household</h5>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form action ="basicSLGMemberedit_saveNI.php" method="POST"> 
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <input type="text" class="form-control" id="region" name="region" value ="<?php echo get_rname($link_cs,$regionID) ; ?>" style="max-width:30%;" readonly>
                                            
                                            <label for="district" class="col-sm-2 col-form-label">District</label>
                                            <input type="text" class="form-control" id="district" name="district" value ="<?php echo dis_name($link_cs,$districtID) ; ?>" style="max-width:30%;" readonly>
                                        </div>
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <input type="text" class="form-control" id="group" name="group" value ="<?php echo grp_name($link_cs,$groupID) ; ?>" style="max-width:30%;" readonly>
                                            
                                            <label for="hstatus" class="col-sm-2 col-form-label">HH Status</label>
                                            <input type="text" class="form-control" id="hstatus" name="hstatus" value ="<?php echo $hhstatus;?>" style="max-width:30%;" readonly>
                                        </div>
