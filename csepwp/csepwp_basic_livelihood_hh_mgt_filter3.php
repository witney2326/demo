            ...
            <div class="container-fluid">
                ...
                <div class="card border border-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="csepwp_basic_livelihood_hh_mgt_filter4.php" method="POST">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <select class="form-select" name="cw" id="cw" required>
                                    <option selected value = "<?php echo $cw; ?>"><?php echo cw_name($link_cs,$cw);?></option>
                                </select>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-header bg-transparent border-primary">
                            <h5 class="my-0 text-default">Beneficiary Households For CW: <?php echo cw_name($link_cs,$cw); ?></h5>
                        </div>
                        <div class="card-body">
                        <h5 class="card-title mt-0"></h5>
