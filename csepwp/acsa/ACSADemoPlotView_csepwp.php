                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">CS-EPWP ACSA Demo Plot View</h4>
                                ...
                                <div class="col-lg-9">
                                    <div class="card border border-success">
                                        <div class="card-header bg-transparent border-success">
                                            <h5 class="my-0 text-default"> ACSA Demo Plot: <?php echo clsname($link_cs,$id);?> Cluster</h5>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <form>
                                                <div class="row mb-1">
                                                    ...
                                                    <input type="text" class="form-control" id="region" name="region" value ="<?php if (isset($regionID)) {echo get_rname($link_cs,$regionID);} else {echo "Region Not Set";} ?>" style="max-width:30%;" disabled ="True">
                                                </div>

                                                
                                                <div class="row mb-1">
                                                    <label for="district" class="col-sm-2 col-form-label">District</label>
                                                    <input type="text" class="form-control" id="district" name="district" value ="<?php if (isset($districtID)) {echo dis_name($link_cs,$districtID) ;} else {echo "District Not Set";} ?>" style="max-width:30%;" disabled ="True">
                                                    
                                                    <label for="ta" class="col-sm-2 col-form-label">TA</label>
                                                    <input type="text" class="form-control" id="ta" name="ta" value ="<?php if (isset($ta)) {echo ta_name($link_cs,$ta);} else {echo "TA Not Set";}?>" style="max-width:30%;" disabled ="True">
                                                </div>
