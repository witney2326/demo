       ...
       $query="select * from tblacsademoplot where cluster='$id'";
        ...
        if ($result_set = $link_cs->query($query)) {
            ...
            { 
                ...
                if (isset($plot)){$set = $row["id"];}else{$set="Not Set";}
            }
            $result_set->close();
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">CS-EPWP ACSA Demo Plot Edit</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="csepwp_acsa_mgt.php">ACSA Management</a></li>
                                ...
                                <div class="col-lg-9">
                                    <div class="card border border-success">
                                        <div class="card-header bg-transparent border-success">
                                            <h5 class="my-0 text-success">Demo Plot Record No. -- <?php echo $set; ?></h5>
                                        </div>
                                        <div class="card-body">
                                            
                                            <form method="POST" action="ACSADemoPlotEditSav_csepwp.php">
                                                
                                                
                                                <div class="row mb-1">
                                                    <label for="rec_no" class="col-sm-2 col-form-label">Record No.</label>
                                                    <input type="text" class="form-control" id="rec_no" name = "rec_no" value="<?php echo $set ; ?>" style="max-width:30%;" readonly>
                                                    
                                                    <label for="cluster_name" class="col-sm-2 col-form-label">Cluster Name</label>
                                                    <input type="text" class="form-control" id="cluster_name" name = "cluster_name" value="<?php echo cluster_name($link_cs,$id) ; ?>" style="max-width:30%;" readonly >
                                                </div>


                                                <div class="row mb-1">
                                                    <label for="district" class="col-sm-2 col-form-label">District</label>
                                                    <input type="text" class="form-control" id="district" name="district" value ="<?php if (isset($districtID)) {echo dis_name($link_cs,$districtID) ;} ?>" style="max-width:30%;" readonly >
                                                    
                                                    <label for="ta" class="col-sm-2 col-form-label">Trad. Authority</label>
                                                    <input type="text" class="form-control" id="ta" name="ta" value ="<?php if (isset($ta)) {echo ta_name($link_cs,$ta) ;} ?>" style="max-width:30%;" readonly >
                                                </div>
