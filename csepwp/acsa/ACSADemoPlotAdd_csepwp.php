                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">CS-EPWP ACSA Demo Plot Add</h4>
                                ...
                                <div class="col-lg-9">
                                    <div class="card border border-success">
                                        <div class="card-header bg-transparent border-success">
                                            <h5 class="my-0 text-default">Add Demo Plot for Cluster: <?php echo cls_name($link_cs,$id);?> </h5>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="ACSADemoPlotAdd_1.php">
                                                ...
                                                <div class="row mb-1">
                                                    ...
                                                    <input type="text" class="form-control" id="region" name="region" value ="<?php echo rname($link_cs,$regionID) ; ?>" style="max-width:30%;"  >
                                                ...
                                                <div class="row mb-1">
                                                    ...
                                                    <input type="text" class="form-control" id="ta" name="ta" value ="<?php echo tname($link_cs,$TAID) ; ?>" style="max-width:30%;"  >
