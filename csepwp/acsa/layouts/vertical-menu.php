                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                <li>
                                    <?php if ($_SESSION["user_role"] == '00'){echo '<a href="javascript: void(0);" class="has-arrow waves-effect" key="t-vertical">Basic-Livelihood </a>' ;}else{echo '<a href="../csepwp_basic_livelihood.php" class="has-arrow waves-effect" key="t-vertical">Basic-Livelihood</a>';}  ?>
                                </li>
                                <li>
