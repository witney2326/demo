                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">CS-EPWP Sensitization and Awareness Meetings</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="../csepwp_basic_livelihood.php">Basic Livelihood</a></li>
                                    <li class="breadcrumb-item active">CS EPWP Sensitization Meetings</li>
                                </ol>
                            </div>
                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border border-primary">
                                                ...
                                                <div class="card-body ">
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="csepwp_basic_livelihood_meetings_filter1_results.php" method ="POST" >
                                                        <div class="col-12">
                                                                ...
                                                                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        echo "<tr>\n";
                                                                            ...
                                                                            echo "<td>
                                                                            <a href=\"basicAwarenessMeetingview_csepwp.php?id=".$row['meetingID']."\"><i class='far fa-eye' title='Meeting Details' style='font-size:18px;color:purple'></i></a>
                                                                            <a onClick=\"javascript: return confirm('Are You Sure You want To Delete This Meeting Record - You Must Be a Supervisor');\" href=\"basicAwarenessMeetingDelete_csepwp.php?id=".$row['meetingID']."\"><i class='far fa-trash-alt' style='font-size:18px;color:red'></i></a>    
                                    ...
                                    <div class="tab-pane" id="new-meeting" role="tabpanel">
                                        <p class="mb-0">
                                            <div class="card border border-primary">
                                                ...
                                                <div class="card-body">
                                                    <h5 class="card-title mt-0"></h5>
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="csepwp_basic_livelihood_new_meeting_filter1_results.php" method ="POST" >
                                                        <div class="col-12">
                                                            <label for="region" class="form-label">Region</label>
