                                                        ...
                                                        <option></option>
                                                            <?php                                                           
                                                                ...
                                                                <option value="<?php echo $DB_ROW_cat["bus_category"]; ?>">
                                                                    <?php echo cat_name($link_cs,$DB_ROW_cat["bus_category"]); ?></option><?php
                                                                    $i++;
                                                                        }
                                                            ?>
                                                    </select>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="<?=$_SERVER['PHP_SELF'];?>">
                                                ...
                                                <div class="row justify-content-end">
                                                        ...
                                                        <div>
                                                            <button type="submit" class="btn btn-btn btn-outline-primary w-md" name="Submit" value="Submit" disabled>Save New ESMP</button>
