                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">CS-EPWP ESS Safeguard Plans</h4>
                                                    ...
                                                    <tbody>
                                                        <?Php
                                                            ...
                                                            { 
                                                                ...
                                                                $amount = number_format($row["budget"],2);
                                                            ...
                                                            echo "<tr>\n";                                           
                                                                ...
                                                                echo "<td>
                                                                    ...
                                                                    <a href=\"basicCLSESMPPlansProgressTrack.php?id=".$row['planID']."\"><i class='fas fa-chart-line' title='Safeguard Implimentation Progress' style='font-size:18px;color:black'></i></a> 
                                                                    <a onClick=\"javascript: return confirm('Are You Sure You want To DELETE This ESMP Record');\" href=\"basicCLSESMPPlansDelete.php?id=".$row['planID']."\"><i class='far fa-trash-alt' style='font-size:18px;color:red'></i></a>        
                                                                </td>\n";
                                                            echo "</tr>\n";
                                                            }
                                                            $result_set->close();
