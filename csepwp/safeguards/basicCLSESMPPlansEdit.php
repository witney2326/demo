                ...
                <div class="row">
                    <div class="col-9">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">CS-EPWP View ESMP</h4>
                        ...
                        <div class="col-lg-9">
                            <div class="card border border-success">
                                <div class="card-header bg-transparent border-success">
                                    <h5 class="my-0 text-success"> SLG View ESMP - <?php echo grp_name($link_cs,$groupID) ; ?></h5>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form> 
                                        <div class="row mb-1">
                                            ...
                                            <input type="text" class="form-control" id="plan_id" name = "plan_id" value="<?php echo $id ; ?>" style="max-width:30%;" readonly>
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <input type="text" class="form-control" id="achieved" name="achieved" value =" <?php echo $achieved ; ?>" style="max-width:30%;">

                                            <label for="achieved_date" class="col-sm-2 col-form-label">Achieved Date</label>
                                            <input type="text" class="form-control" id="achieved_date" name="achieved_date" value ="<?php echo $achieved_date;?>" style="max-width:30%;" readonly>
                                        </div>

                                        <div class="row mb-1">
                                            <label for="budget" class="col-sm-2 col-form-label">Budget</label>
                                            <input type="text" class="form-control" id="budget" name="budget" value =" <?php echo $budget ; ?>" style="max-width:30%;">
                                        ...
                                        <div class="row justify-content-end">
                                                ...
                                                <div>
                                                    ...
                                                    <button type="submit" class="btn btn btn-btn btn-outline-secondary w-md" name="Submit" value="Submit" disabled>Save ESMP Record</button>
