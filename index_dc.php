    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">                                     
                <div class ="row">
                    <?php
                        if ($_SESSION["user_role"] == '04'){echo '<div class="alert alert-warning" role="alert">District Summary!</div>';}
                    ?>
                    <div class="col-xl-6">
                        <div class="card">
                                        ...
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>HHs Reached</td>
                                                    <?php
                                                            $result = mysqli_query($link, "SELECT COUNT(sppCode) AS value_sum FROM tblbeneficiaries where districtID = '$district'"); 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>SLGs Formed</td>
                                                    <?php
                                                        $result = mysqli_query($link, "SELECT COUNT(groupID) AS value_sum FROM tblgroup WHERE ((deleted = '0') and (districtID = '$district'))" ); 
                                                        $row = mysqli_fetch_assoc($result); 
                                                        $sum = $row['value_sum'];
                                                    ?>
                                                    <td><?php echo "" . number_format($sum);?></td>
                                                    <td><?php echo number_format(0);?></td>
                                                    <td><?php if ($_SESSION["user_role"] == '00'){echo '<a href="javascript: void(0);">more..</a>' ;}else{echo '<a href="basic_livelihood_slg_mgt_filter2_results.php">more ..</a>';}  ?></td>              
                                                </tr>
                                                <tr>
                                                    <th scope="row"><i class='fas fa-book-reader' style='font-size:18px'></i></th>
                                                    <td>SLGs Trained</td>
                                                    <?php
                                                        $result = mysqli_query($link, "SELECT count(TrainingID) AS total_grps FROM tblgrouptrainings where (districtID = '$district')"); 
                                                        $row = mysqli_fetch_assoc($result); 
                                                        $sum = $row['total_grps'];
                                                    ?>
                                                    <td><?php echo "" . number_format($sum);?></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>HHs Trained</td>
                                                    <?php
                                                        $result = mysqli_query($link, "SELECT sum(Males+Females) AS total_hhs_trained FROM tblgrouptrainings where (districtID = '$district')"); 
                                                        $row = mysqli_fetch_assoc($result); 
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                        $result = mysqli_query($link, "SELECT COUNT(ClusterID) AS value_cls FROM tblcluster WHERE ((deleted = 0) and (districtID = '$district'))"); 
                                                        $row = mysqli_fetch_assoc($result); 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>JSGs Formed</td>
                                                    <?php
                                                        $result = mysqli_query($link, "SELECT COUNT(recID) AS value_total FROM tbljsg where (districtID = '$district')"); 
                                                        $row = mysqli_fetch_assoc($result); 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Youths Linked</td>
                                                    <?php
                                                        $result = mysqli_query($link, "SELECT COUNT(recID) AS v_total FROM tblycs where (districtID = '$district')"); 
                                                        $row = mysqli_fetch_assoc($result); 
                                                        $v_total = $row['v_total'];
                                                    ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                        $result = mysqli_query($link, "SELECT COUNT(groupID) AS value_grps FROM tblgroup where ((grad_status='1') and (districtID = '$district'))"); 
                                                        $row = mysqli_fetch_assoc($result); 
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                        $result = mysqli_query($link, "SELECT COUNT(groupID) AS v_total FROM tblgroup where ((vc_status = '1') and (districtID = '$district'))"); 
                                                        $row = mysqli_fetch_assoc($result); 
                                                        $v_total = $row['v_total'];
                                                    ?>
                                                    <td><?php echo "" . number_format($v_total);?></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                        $select_query_esmp = "SELECT COUNT(planID) as TotalESMPs FROM tblsafeguard_group_plans where districtID = '$district'";
                                                ...
                                                <tr>
                                                    ...
                                                    <?php 
                                                        $select_query = "SELECT SUM(amount) as TotalSavings FROM tblslg_member_savings where districtID = '$district'";
                                                        $query_result = mysqli_query($link,$select_query);
