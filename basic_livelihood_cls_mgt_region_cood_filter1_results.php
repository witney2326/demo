                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" >
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div>
                                                                <select class="form-select" name="district" id="district" value ="<?php echo $_SESSION["district-9-10"];?>" required disabled>
                                                        ...
                                                        <div class="col-12">
                                                            <a href="basic_livelihood_cls_mgt_region_cood_filter_results.php">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="card-header bg-transparent border-primary">
                                                        <h5 class="my-0 text-default">Clusters in ...</h5>
                                                    </div>
                                                    <div class="card-body">
