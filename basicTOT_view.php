                                                                ...
                                                                <tbody>
                                                                    <?Php
                                                                        ...
                                                                        echo "<tr>\n";
                                                                            ...
                                                                            echo "<td>
                                                                                <a href=\" ?id=".$row['TrainID']."\"><i class='far fa-eye' title ='Training Status' style='font-size:18px;color:purple'></i></a>                                                                      
                                                                                <a href=\" ?id=".$row['TrainID']."\" ><i class='fas fa-pen' title ='Record TOT Training' style='font-size:18px;color:green'></i></a>                                                                           
                                                                                <a href=\" ?id=".$row['TrainID']."\" ><i class='fas fa-poll' title = 'Training Reports' style='font-size:18px;color:cadetblue'></i></a>       
                                                                            </td>\n";
                                                                        echo "</tr>\n";
                                                                        }
                                                                        $result_set->close();
