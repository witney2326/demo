                        ...
                        <div class="col-lg-9">
                            <div class="card border border-success">
                                <div class="card-header bg-transparent border-success">
                                    <h5 class="my-0 text-success"> SLG View/Edit ESMP - <?php echo grp_name($link,$groupID) ; ?></h5>
                                </div>
                                <div class="card-body">
                                    
                                    <form> 
                                        <div class="row mb-1">
                                            <label for="plan_id" class="col-sm-3 col-form-label">Plan ID</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="row mb-1">
                                            <label for="bustype" class="col-sm-3 col-form-label">Busines Type</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="row mb-1">
                                            <label for="hstatus" class="col-sm-3 col-form-label">Target</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="row justify-content-end">
                                            <div class="col-sm-9">
                                                <div>
                                                    ...
                                                    <button type="submit" class="btn btn-secondary w-md" name="Submit" value="Submit" disabled>Save ESMP Record</button>
