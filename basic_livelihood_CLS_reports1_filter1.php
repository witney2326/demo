                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Clusters Per Case Worker</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="basicReports.php">Basic Livelihood Reports</a></li>
                                    <li class="breadcrumb-item active">Cluster Reports</li>
                                </ol>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="card border border-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="basic_livelihood_CLS_reports1_filter2.php" method ="POST" >
                                ...
                                <div class="card border border-primary">
                                    <div class="card-header bg-transparent border-primary">
                                        <h5 class="my-0 text-primary">Clusters Per Case Worker in Region: <?php echo get_rname($link,$region);?></h5>
                                    </div>
                                        <div class="card-body">
                                            ...
                                            <table id="datatable-buttons" class="table table-bordered dt-responsive  nowrap w-100">
                                                ...
                                                <tbody>
                                                    <?Php
                                                        ...
                                                        $query="SELECT tblcw.cwName,tblcluster.districtID,tblcluster.ClusterName, tblcluster.cohort, tblcluster.programID
                                                        FROM tblcluster 
                                                        INNER JOIN tblcw on tblcw.cwID = tblcluster.cwID where tblcluster.regionID ='$region'";
