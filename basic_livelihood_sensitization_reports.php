...
<head>
    <title>Sensitization Reports</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Sensitization Reports</h4>
                                ...
                                <ul class="nav nav-pills nav-justified" role="tablist">
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#hotspots" role="tab">
                                            ...
                                            <span class="d-none d-sm-block">Sensitization Meetings</span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" data-bs-toggle="tab" href="#district-summary" role="tab">
                                            <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                            <span class="d-none d-sm-block">Summary Meetings Per District</span>
                                        </a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
