                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border border-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="basic_livelihood_member_mgt_filter3.php" method="GET">
                                                        <div class="col-12">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <select class="form-select" name="grp" id="grp" required >
                                                                ...
                                                                <?php   
                                                                        $district = $_GET['district'];                                               
                                                                        $grp_fetch_query = "SELECT groupID,groupname FROM tblgroup where DistrictID ='$district'";                                                  
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="card border border-primary">
                                                    <div class="card-header bg-transparent border-primary">
                                                        <h5 class="my-0 text-primary">SLG- Members in <?php echo dis_name($link,$_GET['district']);?> District</h5>
                                                    </div>
                                                    <div class="card-body">
                                                    <h5 class="card-title mt-0"></h5>
