...
<head>
    <title>Graduation Reports | Graduation Livelihood</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Graduation Livelihood Reports</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="basic_livelihood.php">Graduation Livelihood</a></li>
                                    <li class="breadcrumb-item active">Graduation Livelihood Reports</li>
                                </ol>
                            </div>
