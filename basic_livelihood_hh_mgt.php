                                ...
                                <ul class="nav nav-pills nav-justified" role="tablist">
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" data-bs-toggle="tab" href="#messages-2" role="tab">
                                            ...
                                            <span class="d-none d-sm-block">New Household</span>
                                        </a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
                                ...
                                <div class="tab-content p-3 text-muted">
                                        ...
                                        <p class="mb-0">
                                            <div class="card border border-primary">
                                                <div class="card-header bg-transparent border-primary">
                                                    <h5 class="my-0 text-primary"><i class="mdi mdi-bullseye-arrow me-3"></i>Beneficiary Household Management</h5>
                                                </div>
                                                <div class="card-body">
                                    ...
                                    <div class="tab-pane" id="messages-2" role="tabpanel">
                                        <p class="mb-0">
                                            <div class="card border border-primary">
                                                <div class="card-header bg-transparent border-primary">
                                                    <h5 class="my-0 text-primary"><i class="mdi mdi-bullseye-arrow me-3"></i>New Household</h5>
                                                </div>
                                                <div class="card-body">
                                                    <h5 class="card-title mt-0"></h5>
