...
<head>
    <title>Blog Grid | Skote - Admin & Dashboard Template</title>
                                                ...
                                                <div>
                                                        ...
                                                        <div class="col-8">
                                                            <div>
                                                                <ul class="nav nav-pills justify-content-end">
                                                                    ...
                                                                    <li class="nav-item">
                                                                        <a class="nav-link active" href="blog-grid.php">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="card p-1 border shadow-none">
                                                                <div class="p-3">
                                                                    <h5><a href="blog-details.php" class="text-dark">Drawing a sketch</a></h5>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="card p-1 border shadow-none">
                                                                <div class="p-3">
                                                                    <h5><a href="blog-details.php" class="text-dark">Riding bike on road</a></h5>
                                                                    <p class="text-muted mb-0">10 Apr, 2020</p>
                                                                </div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div>
                                    ...
                                    <ul class="list-unstyled fw-medium">
                                        ...
                                        <li><a href="#" class="text-muted py-2 d-block"><i class="mdi mdi-chevron-right me-1"></i> Development <span class="badge badge-soft-success badge-pill float-end ms-1 font-size-12">04</span></a></li>
                                        ...
                                        <li><a href="#" class="text-muted py-2 d-block"><i class="mdi mdi-chevron-right me-1"></i> Travel<span class="badge badge-soft-success badge-pill ms-1 float-end font-size-12">12</span></a></li>
                                    </ul>
                                </div>
