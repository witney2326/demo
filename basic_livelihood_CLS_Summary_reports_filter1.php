                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Cluster Summary Reports</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="basicReports.php">Basic Livelihood Reports</a></li>
                                    <li class="breadcrumb-item active">Cluster Summary Report</li>
                                </ol>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="card border border-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="basic_livelihood_CLS_Summary_reports_filter2.php" method ="GET" >
                                            <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="card-body">
                                                <table id="datatable-buttons" class="table table-bordered dt-responsive  nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        <?Php
                                                            $query="SELECT tblcw.cwName,tblcluster.districtID,COUNT(tblcluster.ClusterName) as Clusters, tblcluster.cohort
                                                            FROM tblcluster 
