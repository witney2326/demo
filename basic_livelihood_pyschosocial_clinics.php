...
<head>
    <title>Pyschosocial Clinics</title>
...
<?php include 'layouts/body.php'; 
    ...
    function ta_name($link, $tcode)
        {
        $ta_query = mysqli_query($link,"select TAName from tblta where TAID='$tcode'"); // select query
        $tas = mysqli_fetch_array($ta_query);// fetch data
        return $tas['TAName'];
    }
                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="basic_livelihood_cbdra.php">Basic Livelihood CBDRA</a></li>
                                ...
                                <ul class="nav nav-pills nav-justified" role="tablist">
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#home-1" role="tab">
                                            ...
                                            <span class="d-none d-sm-block">Clinics</span>
                                        </a>
                                    </li>
                                ...
                                <div class="tab-content p-3 text-muted">
                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border border-primary">
                                                <div class="card-header bg-transparent border-primary">
                                                    <h5 class="my-0 text-primary"></i>Location Filter For Clinics</h5>
                                                </div>
                                                <div class="card-body">
                                                    <h5 class="card-title mt-0"></h5>
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="basic_livelihood_pyschosocial_clinics_filter1.php" method ="GET" >
                                                        <div class="col-12">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <select class="form-select" name="ta" id="ta" value ="$ta" required disabled>
                                                                <option selected value="$ta" ></option>
                                                                    <?php                                                           
                                                                        $ta_fetch_query = "SELECT TAID,TAName FROM tblta";                                                  
                                    ...
                                    <div class="tab-pane" id="new-meeting" role="tabpanel">
                                        <p class="mb-0">
                                            ...
                                            <div class="card border border-primary">
                                                <div class="card-header bg-transparent border-primary">
                                                    <h5 class="my-0 text-primary"></i>Location Filter For New CBDRA Clinic</h5>
                                                </div>
                                                <div class="card-body">
                                                    <h5 class="card-title mt-0"></h5>
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="basic_livelihood_new_clinic_filter1.php" method ="GET" >
                                                        <div class="col-12">
                                                            <label for="region" class="form-label">Region</label>
