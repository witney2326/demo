                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="basic_livelihood_pyschosocial_clinics.php">Basic Livelihood Clinics</a></li>
                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border border-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="basic_livelihood_pyschosocial_clinics_filter2.php" method ="GET">
                                                        <div class="col-12">
                                                    ...
                                                    <h5 class="card-title mt-0"></h5>
                                                            ...
                                                            <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                                ...
                                                                <tbody>
                                                                    <?Php
                                                                        $region = $_GET["region"];
                                                                        $query="select * from tblclinics where regionID='$region'";
