                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="card border border-primary">
                                    <div class="card-header bg-transparent border-primary">
                                        <h5 class="my-0 text-primary">Clusters Per Case Worker For Case Worker: <?php echo cw_name($link,$cw); ?></h5>
                                    </div>
                                        <div class="card-body">
                                            ...
                                            <table id="datatable-buttons" class="table table-bordered dt-responsive  nowrap w-100">
                                                ...
                                                <tbody>
                                                    <?Php
                                                        ...
                                                        FROM tblcluster 
                                                        INNER JOIN tblcw on tblcw.cwID = tblcluster.cwID where tblcluster.cwID ='$cw'";
