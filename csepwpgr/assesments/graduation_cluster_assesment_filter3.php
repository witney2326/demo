...
<?php		
   ...
   else
   {
       ...
       $ta = $_POST['ta'];
         ...
         function ta_name($link_cs, $ID)
         {
         $ta_query = mysqli_query($link_cs,"select TAName from tblta where TAID='$ID'"); // select query
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card border border-primary">
                                        <div class="card-header bg-transparent border-primary">
                                            <h5 class="my-0 text-default">Clusters in TA: <?php echo ta_name($link_cs,$ta);?></h5>
                                        </div>
                                        <div class="card-body">
                                        <h5 class="card-title mt-0"></h5>
