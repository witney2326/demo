                    ...
                    <div class="col-12">
                        ...
                        <div class="card border border-success">
                            <div class="card-header bg-transparent border-success">
                                <h5 class="my-0 text-success">New CF for :<?php echo get_clustername($link,$id); ?> Cluster</h5>
                            </div>
                            <div class="card-body">
                                
                                <form method="POST" action="graduation_add_cf_code.php">

                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="cluster_id" class="form-label">Cluster ID</label>
                                                <input type="text" class="form-control" id="cluster_id" name = "cluster_id" value="<?php echo $id ; ?>"readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="cluster_name" class="form-label">Cluster Name</label>
                                                <input type="text" class="form-control" id="cluster_name" name ="cluster_name" value = "<?php echo get_clustername($link,$id) ; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="region" class="form-label">Region</label>
                                                <input type="text" class="form-control" id="region" name="region" value ="<?php echo get_rname($link,get_regionID($link,$id)) ; ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="district" name = "district" value="<?php echo dis_name($link,get_disID($link,$id)); ?>"readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="ta" class="form-label">Traditional Authority</label>
                                                <input type="text" class="form-control" id="ta" name ="ta" value = "<?php echo get_taID($link,$id); ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="gvh" class="form-label">Group Village Head</label>
                                                <input type="text" class="form-control" id="gvh" name="gvh" value ="<?php echo get_gvhID($link,$id) ; ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                <label for="cfName" class="form-label">CF Name</label>
                                        ...
                                        <div class="col-md-2">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="cfgrp" name ="cfgrp" required>
                                                    <?php                                                           
                                                        $spp_fetch_query = "SELECT groupID,groupname FROM tblgroup where clusterID = '$id'";                                                  
                                                        $result_spp_fetch = mysqli_query($link, $spp_fetch_query);                                                                       
                                                        $i=0;
                                                            while($DB_ROW_spp = mysqli_fetch_array($result_spp_fetch)) {
                                                        ?>
                                                        <option value ="<?php echo $DB_ROW_spp["groupID"]; ?>">
                                                            <?php echo $DB_ROW_spp["groupname"]; ?></option><?php
                                                            $i++;
                                                                }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                <label for="spp_programme" class="form-label">CF HH Code</label>
                                                <select class="form-select" id="hhcode" name ="cfgrp" disabled>
                                                    <?php                                                           
                                                        $spp_fetch_query = "SELECT sspCode FROM tblbeneficiary where groupID = '$id'";                                                  
                                                        $result_spp_fetch = mysqli_query($link, $spp_fetch_query);                                                                       
                                                        $i=0;
                                                            while($DB_ROW_spp = mysqli_fetch_array($result_spp_fetch)) {
                                                        ?>
                                    ...
                                    <div class="col-md-0">
                                        <div class="mb-3">
                                            <div>
                                                <button type="submit" class="btn btn-btn btn-outline-success w-md" style="width:170px" name="populate_hh_code" value="populate_hh_code">Populate HH Codes</button>   
