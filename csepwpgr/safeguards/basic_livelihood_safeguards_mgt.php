...
<?php 
    ...
    function issue_name($link_cs, $icode)
        {
        $rg_query = mysqli_query($link_cs,"select name from tblissues where id='$icode'"); // select query
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">CS-EPWP Safeguards Management</h4>
                                ...
                                <ul class="nav nav-pills nav-justified" role="tablist">
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" data-bs-toggle="link" href="basicReports.php" role="link">
                                            <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                            <span class="d-none d-sm-block">ESMP Reports</span>
                                        </a>
                                    </li>
                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border border-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="basic_livelihood_safeguards_mgt_filter1.php" method ="POST" >
                                                        <div class="col-12">
