                                            ...
                                            <div class="col-12">
                                                ...
                                                <div>
                                                    <select class="form-select" name="buscat" id="buscat" value ="<?php echo $buscat; ?>" required>
                                                        <option selected value="<?php echo $buscat; ?>"><?php echo cat_name($link_cs,$buscat); ?></option>       
                                                    </select>
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <select class="form-select" name="bustype" id="bustype" value ="" style="max-width:30%;" required >
                                                        ...
                                                        <?php                                                           
                                                            ...
                                                            $result_type_fetch = mysqli_query($link_cs, $type_fetch_query);                                                                       
                                                            $i=0;
                                                                while($DB_ROW_type = mysqli_fetch_array($result_type_fetch)) {
                                                            ?>
                                                            <option value="<?php echo $DB_ROW_type["type"]; ?>">
                                                                <?php echo iga_name($link_cs,$DB_ROW_type["type"]); ?></option><?php
                                                                $i++;
                                                                    }
                                                        ?>
                                                    </select>
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <select class="form-select" name="sactivity" id="sactivity" value ="" style="max-width:30%;" required>
                                                        ...
                                                        <?php                                                           
                                                            ...
                                                            $result_act_fetch = mysqli_query($link_cs, $act_fetch_query);                                                                       
                                                            $i=0;
                                                    ...
                                                    <select class="form-select" name="indicator" id="indicator" value ="" style="max-width:30%;" required>
                                                        ...
                                                        <?php                                                           
                                                            ...
                                                            $result_indi_fetch = mysqli_query($link_cs, $indi_fetch_query);                                                                       
                                                            $i=0;
                                                                while($DB_ROW_indi = mysqli_fetch_array($result_indi_fetch)) {
                                                            ?>
                                                            <option value="<?php echo $DB_ROW_indi["indicatorID"]; ?>">
                                                                <?php echo indicator_name($link_cs,$DB_ROW_indi["indicatorID"]); ?></option><?php
                                                                $i++;
                                                                    }
                                                        ?>
                                                    </select>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="card-header bg-transparent border-primary">
                                            <h5 class="my-0 text-primary">ESS Safeguards Plan -SLG- <?php echo $groupname ; ?></h5>
                                        </div>
                                        <div class="card-body">
                                        <h5 class="card-title mt-0"></h5>
                                                    ...
                                                    <tbody>
                                                        <?Php
                                                            ...
                                                            { 
                                                                ...
                                                                $ig_name = iga_name($link_cs,$row["busTypeID"]);
                                                                $activity = activity_name($link_cs,$row["activityID"]);
                                                                $indicator = indicator_name($link_cs,$row["indicator"]);
                                                            ...
                                                            echo "<tr>\n";                                           
                                                                ...
                                                                echo "<td>
                                                                    <a href=\"basicCLSESMPPlansEdit.php?id=".$row['planID']."\"><i class='far fa-eye' style='font-size:18px;color:purple'></i></a> 
                                                                    <a onClick=\"javascript: return confirm('Are You Sure You want To DELETE This Record');\" href=\"basicCLSESMPPlansDelete.php?id=".$row['planID']."\"><i class='far fa-trash-alt' style='font-size:18px;color:red'></i></a>        
                                                                </td>\n";
                                                            echo "</tr>\n";
                                                            }
                                                            $result_set->close();
