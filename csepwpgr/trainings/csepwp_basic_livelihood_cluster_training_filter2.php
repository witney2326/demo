                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="csepwp_basic_livelihood_cluster_training.php">Cluster Training Management</a></li>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="card border border-primary">
                                                        <h5 class="my-0 text-default">SL Clusters in District: <?php echo dis_name($link_cs,$district);?></h5>
                                                    <div class="card-body">
