                            ...
                            <div class="card-body">
                                <div class="card border border-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="Rp_Selected_Ben_reports_filter3.php" method ="POST" >
                                ...
                                <div class="card border border-primary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="datatable-buttons" class="table table-bordered dt-responsive  nowrap w-100">
                                                ...
                                                <tbody>
                                                    <?Php
                                                        $query="SELECT sppCode, hh_head_name, districtID, groupID, spProg FROM tblbeneficiaries where ((grad_status = '1') and (districtID = '$district'))";
