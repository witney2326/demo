                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border border-primary">
                                                <div class="card-header bg-primary border-primary">
                                                    <h5 class="my-0 text-default"></i>SLG Search Filter</h5>
                                                </div>
                                                <div class="card-body bg-success">
                                                    <h5 class="card-title mt-0"></h5>
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="basic_livelihood_slg_mgt_filter2_results.php" method ="GET">
                                                        <div class="col-12">
                                                                ...
                                                                <tbody>
                                                                    <?Php
                                                                        ...
                                                                        echo "<tr>\n";
                                                                            ...
                                                                            <a href=\"basicSLGloans.php?id=".$row['groupID']."\"><i class='fas fa-book' title='Add SLG Loans' style='font-size:18px;color:green'></i></a> 
