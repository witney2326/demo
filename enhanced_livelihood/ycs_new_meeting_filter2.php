...
<?php 
    ...
    function get_rname($link, $rcode)
        ...
        function sector_name($link, $secID)
        {
        $sec_query = mysqli_query($link,"select name from tblsector where id='$secID'"); // select query
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="card-header bg-transparent border-primary">
                                                        <h5 class="my-0 text-primary"><i class="mdi mdi-bullseye-arrow me-3"></i> New YCS Sensitization Meeting in <?php echo dis_name($link,$district); ?></h5>
                                                    </div>
                                                    <div class="card-body">
                                                    <div class="card border border-primary">
                                                ...
                                                <div class="card-body">
                                                    <h5 class="card-title mt-0"></h5>
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="ycs_add_Meeting.php" method="post">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select" name="sectorID" id="sectorID" required>
                                                                        <option selected value="13"><?php echo sector_name($link,'13')?></option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input class="form-text" name="NoOrientedF" id="NoOrientedF" required style="width:40px">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <label for="NoOrientedM" class="form-label">No. Males Oriented</label>
                                                                    <input class="form-text" name="NoOrientedM" id="NoOrientedM" required style="width:40px">
