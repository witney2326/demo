                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">LESP Assesment</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="vc_lesp.php">LESP Management</a></li>
                                    <li class="breadcrumb-item active">LESP Assesment</li>
                                </ol>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="card border border-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="vc_lesp_group_assesment_filter1.php" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="card-header bg-transparent border-primary">
                                            <h5 class="my-0 text-primary">SL Clusters</h5>
                                        </div>
                                        <div class="card-body">
                                        <h5 class="card-title mt-0"></h5>
                                                ...
                                                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        <?Php
                                                            $query="select * from tblcluster where ((deleted = '0') and (regionID = '0') and (ClusterName <> ''))";
                                                        
                                                            if ($result_set = $link->query($query)) {
                                                            while($row = $result_set->fetch_array(MYSQLI_ASSOC))
                                                            { 
                                                                if ($row["lesp_assesed"] == 1){$lesp_assesed = "Yes";}else{$lesp_assesed = "No";} 
                                                                if ($row["lesp_assesed_result"] == 1){$lesp_assesed_result = "Poor";}if ($row["lesp_assesed_result"] == 2){$lesp_assesed_result = "Good";}if ($row["lesp_assesed_result"] == 0){$lesp_assesed_result = "NA";}
                                                            ...
                                                            echo "<tr>\n";
                                                                ...
                                                                echo "<td>";
                                                                    echo "<form action = 'vc_lesp_ratecls.php' method ='POST'>";
                                                                ...
                                                                echo "\t\t<td>$lesp_assesed</td>\n";
                                                                echo "\t\t<td>$lesp_assesed_result</td>\n";
                                                                ...
                                                                echo "<a onClick=\"javascript: return confirm('Are You Sure You want To PUT This Cluster On LESP');\" href=\"vc_lesp_clsMapping.php?id=".$row['ClusterID']."\"\><i class='far fa-check-circle' title='Map Cluster For LESP' style='font-size:18px;color:green'></i></a>\n";
