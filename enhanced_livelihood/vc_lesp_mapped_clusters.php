                            ...
                            <div class="card-body">
                                ...
                                <div class="card border border-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="vc_lesp_mapped_clusters_filter1.php" method="POST">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <h5 class="card-title mt-0"></h5>
                                                ...
                                                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        <?Php
                                                            $query="select * from tblcluster where ((deleted = '0') and (regionID = '0') and (ClusterName <> '') and (lesp_status ='1'))";
                                                            ...
                                                            echo "<tr>\n";
                                                                ...
                                                                echo "<a onClick=\"javascript: return confirm('Are You Sure You want To PUT This Cluster On LESP');\" href=\"vc_lesp_cluster_lesp.php?id=".$row['ClusterID']."\"\><i class='fa fa-leaf' title='Update LESP Cluster Details' style='font-size:18px;color:green'></i></a>\n";
