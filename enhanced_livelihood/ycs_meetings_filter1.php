                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border border-primary">
                                                <div class="card-header bg-transparent border-primary">
                                                    <h5 class="my-0 text-primary"></i>Sensitization Meeting Filter</h5>
                                                </div>
                                                <div class="card-body">
                                                    <h5 class="card-title mt-0"></h5>
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="ycs_meetings_filter2.php" method ="GET">
                                                        <div class="col-12">
                                                    ...
                                                    <h5 class="card-title mt-0"></h5>
                                                            ...
                                                            <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                                ...
                                                                <tbody>
                                                                    <?Php
                                                                        $region = $_GET["region"];
                                                                        $query="select * from tblawareness_meetings where ((regionID='$region') and (sectorID ='13'))";
