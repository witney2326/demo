...
<?php
 include '../layouts/session.php';
    ...
    if (($_SESSION["user_role"]== '05')) {
        header("location: ycs_clusters_filter3.php");   
    }
    if (($_SESSION["user_role"]== '04')) {
        header("location: ycs_clusters_filter2.php");   
    }
    if (($_SESSION["user_role"]== '03')) {
        header("location: ycs_clusters_filter1.php");   
    }

    if (($_SESSION["user_role"]== '02')) {
        header("location: ycs_clusters.php");   
    }
