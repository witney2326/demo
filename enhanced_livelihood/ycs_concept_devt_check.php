...
<?php
 include '../layouts/session.php';
    ...
    if (($_SESSION["user_role"]== '05')) {
        header("location: ycs_concept_devt_filter3.php");   
    }
    if (($_SESSION["user_role"]== '04')) {
        header("location: ycs_concept_devt_filter2.php");   
    }
    if (($_SESSION["user_role"]== '03')) {
        header("location: ycs_concept_devt_filter1.php");   
    }

    if (($_SESSION["user_role"]== '02')) {
        header("location: ycs_concept_devt.php");   
    }
