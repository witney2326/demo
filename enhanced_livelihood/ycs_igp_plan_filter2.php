                            ...
                            <div class="card-body">
                                ...
                                <ul class="nav nav-pills nav-justified" role="tablist">
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" data-bs-toggle="link" href="ycs_igp_check.php" role="link">
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="link"  href="ycs_igp_plan_fin_link_check.php" role="link">
                                            <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="card-header bg-transparent border-primary">
                                            <h5 class="my-0 text-primary">IGPs Under District</h5>
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    <tbody>
                                                        <?Php
                                                            ...
                                                            echo "<tr>\n";                                           
                                                                ...
                                                                echo "<td>
                                                                    <a href=\"ycs_igp_fin_link.php?id=".$row['hh_code']."\"><i class='fas fa-donate' title='COMSIV Link' style='font-size:18px;color:orange'></i></a>     
                                                                </td>\n";
                                                            echo "</tr>\n";
                                                            }
                                                            $result_set->close();
