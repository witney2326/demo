                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">YCS Income Generating Projects</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="ycs.php">YCS Dashboard</a></li>
                                    <li class="breadcrumb-item active">YCS IGP</li>
                                </ol>
                            </div>
                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border border-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="ycs_igp_filter2.php" method ="POST">
                                                        <div class="col-12">
                                                            ...
                                                            <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                                ...
                                                                <tbody>
                                                                    <?Php
                                                                        if (isset($region))
                                                                        {
                                                                            $query="select * from tblycs inner join tblgroup on tblycs.groupID = tblgroup.groupID where ((tblycs.bc_assesed_result ='1') and (tblgroup.regionID = '$region'))";
                                                                        ...
                                                                        if ($result_set = $link->query($query)) {
                                                                            ...
                                                                            echo "<td>
                                                                                ...
                                                                                <a href=\"ycs_igp_projects.php?id=".$row['recID']."\"><i class='fas fa-project-diagram' title='IGP Plan' style='font-size:18px;color:green'></i></a> 
                                                                                <a href=\".php?id=".$row['recID']."\"><i class='fas fa-donate' title='COMSIV Link' style='font-size:18px;color:orange'></i></a>     
                                                                                </td>\n";
                                                                            echo "</tr>\n";
                                                                            }
                                                                            $result_set->close();
