                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card border border-primary">
                                        <div class="card-header bg-transparent border-primary">
                                            <h5 class="my-0 text-primary">SLGs/Clusters</h5>
                                        </div>
                                        <div class="card-body">
                                        <h5 class="card-title mt-0"></h5>
                                                ...
                                                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        echo "<tr>\n";
                                                            ...
                                                            echo "<a onClick=\"javascript: return confirm('Are You Sure You want To PUT This SLG On Graduation- You Must Be a Supervisor');\" href=\"graduationSLGAssesment.php?id=".$row['ClusterID']."\"\><i class='fa fa-graduation-cap' title='Put SLG On Graduation Pilot' style='font-size:18px'></i></a>\n";
