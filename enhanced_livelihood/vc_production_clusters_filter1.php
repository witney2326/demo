                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border border-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="vc_production_clusters_filter2.php" method ="GET">
                                                        <div class="col-12">
                                                        ...
                                                        <tbody>
                                                            <?Php
                                                                ...
                                                                { 
                                                                    ...
                                                                    echo "<td>
                                                                        <a onClick=\"javascript: return confirm('Are You Sure You want To Map This Cluster For VC Production Intervention? ');\" href=\"vc_cls_map.php?id=".$row['ClusterID']."\"><i class='fas fa-map' title='Map Cluster For VC Production Intervention' style='font-size:18px'></i></a>\n
                                                                    </td>\n";
