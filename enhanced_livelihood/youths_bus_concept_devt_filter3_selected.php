            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <h4 class="mb-sm-0 font-size-18">Selected Concepts</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="ycs.php">YCS Management</a></li>
                                <li class="breadcrumb-item active">Selected Concepts</li>
                            </ol>
                        </div>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div>
                                                                <select class="form-select" name="ta" id="ta" required >
                                                                    <option selected value = "<?php echo $ta;?>"><?php echo tname($link,$ta);?></option>                                                               
                                                                </select>
                                                            </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <h7 class="card-title mt-0"></h7>
                                                            ...
                                                            <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100"style=font-size:12px>
                                                                ...
                                                                <tbody>
                                                                    <?Php
                                                                        $query="select * from tblycs inner join tblgroup on tblycs.groupID = tblgroup.groupID where ((tblgroup.TAID = '$ta') and (tblycs.bc_assesed_result ='1'))";
