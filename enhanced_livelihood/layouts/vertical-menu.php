            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                <li class="menu-title" key="t-menu"><?php echo $language["Menu"]; ?></li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="waves-effect">
                            <span class="badge rounded-pill bg-success float-end" key="t-new"></span>
                            <i class="fas fa-signal" style='font-size:18px;color:orange'></i>
                            <span key="t-authentication">CSEPWP Indicator Table</span>
                        </a>
                        
                    </li>
                    <li>
                        <a href="/cms1/index.html" class="waves-effect">
                            <span class="badge rounded-pill bg-success float-end" key="t-new"></span>
                            <i class="fas fa-exclamation" style="color:black"></i>
                            <span key="t-authentication">Case Management</span>
                        </a>
