                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border border-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="jsg_mgt_filter3.php" method ="GET">
                                                        <div class="col-12">
                                                                ...
                                                                <tbody>
                                                                    <?Php
                                                                        ...
                                                                        echo "<tr>\n";
                                                                            ...
                                                                            <a href=\"SLG_iga_view.php?id=".$row['groupID']."\"><i class='fas fa-balance-scale' title='View SLG IGAs' style='font-size:18px'></i></a> 
                                                                            <a href=\"add_JSG.php?id=".$row['groupID']."\"><i class='fa fa-users' title='Add JSG to SLG' style='font-size:18px'></i></a> 
