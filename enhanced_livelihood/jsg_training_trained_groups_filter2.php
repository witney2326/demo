                    ...
                    <div class="col-xl-9">    
                        <div class="card border border-primary">
                            ...
                            <div class="card-body">
                                ...
                                <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="basic_livelihood_slg_training_trained_groups_filter3.php" method ="POST" >
                                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-9">
                        ...
                        <div class="card-header bg-transparent border-primary">
                            <h5 class="my-0 text-primary">Trained JSGs in <?php echo dis_name($link,$district); ?></h5>
                        </div>
                        <div class="card-body">
