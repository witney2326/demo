<?php
  ...
  if(($_SESSION["region-9-10"] !== "00") && ($_SESSION["district-9-10"] !== "00") && ($_SESSION["ta-9-10"] !== "0000") && ($_SESSION["cw-9-10"] !== "00")){
    header("location: basic_livelihood_cls_mgt_district_cood_filter4_results.php");
  }
  else if(($_SESSION["region-9-10"] !== "00") && ($_SESSION["district-9-10"] !== "00") && ($_SESSION["ta-9-10"] !== "0000") && ($_SESSION["cw-9-10"] == "00")){
    header("location: basic_livelihood_cls_mgt_district_cood_filter3_results.php");
  }
  else if(($_SESSION["region-9-10"] !== "00") && ($_SESSION["district-9-10"] !== "00") && ($_SESSION["ta-9-10"] == "0000") && ($_SESSION["cw-9-10"] == "")){
    header("location: basic_livelihood_cls_mgt_district_cood_filter2_results.php");
  }
  else if(($_SESSION["region-9-10"] !== "00") && ($_SESSION["district-9-10"] == "00") && ($_SESSION["ta-9-10"] == "0000") && ($_SESSION["cw-9-10"] == "")){
    header("location: basic_livelihood_cls_mgt_district_cood_filter1_results.php");
  }
  else if(($_SESSION["region-9-10"] == "00") && ($_SESSION["district-9-10"] == "00") && ($_SESSION["ta-9-10"] == "0000") && ($_SESSION["cw-9-10"] == "")){
