                            ...
                            <div class="card-body">
                                ...
                                <div class="card border border-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="basic_livelihood_CLS_Summary_reports_filter1.php" method ="GET" >
                                            <div class="col-12">
                                                ...
                                                <table id="datatable-buttons" class="table table-bordered dt-responsive  nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        <?Php
                                                            ...
                                                            FROM tblcluster 
                                                            INNER JOIN tblcw on tblcw.cwID = tblcluster.cwID where tblcluster.districtID ='00'
