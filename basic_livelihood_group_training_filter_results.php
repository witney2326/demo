                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border border-primary">
                                                <div class="card-header bg-transparent border-primary">
                                                    <h5 class="my-0 text-primary"></i>SLG Training Search Results For:</h5>
                                                </div>
                                                <div class="card-body">
                                                            ...
                                                            <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                                ...
                                                                <tbody>
                                                                    <?Php
                                                                        ...
                                                                        {
                                                                            $query="select * from tblgrouptrainings where ((districtID = '$district' AND regionID = '$region') OR (districtID = '$district') OR (regionID = '$region')) " ;
                                                                        ...
                                                                        if ($result_set = $link->query($query)) {
                                                                            ...
                                                                            echo "<tr>\n";
                                                                                ...
                                                                                echo "<td>                                                                            
                                                                                    <a href=\"basicTrainingGD.php?id=".$row['groupID']."\" >GD</a>   
                                                                                    <a href=\"basicTrainingFLT.php?id=".$row['groupID']."\">FLT</a> 
                                                                                    <a href=\"basicTrainingBMT.php?id=".$row['groupID']."\">BMT</a>
                                                                                    <a href=\"basicTrainingRK.php?id=".$row['groupID']."\">RK</a> 
                                                                                    <a href=\"basicTrainingBK.php?id=".$row['groupID']."\">BK</a> 
                                                                                    <a href=\"basicTrainingSG.php?id=".$row['groupID']."\">SG</a>
                                                                                    <a href=\"basicTrainingGN.php?id=".$row['groupID']."\">GN</a>
