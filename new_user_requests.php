...
<?php        
                ...
                $query1 = "SELECT COUNT(*) AS useremail FROM users";
                $result1 = mysqli_query($link, $query1);
                $row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC);
                $total = $row1['useremail'];
                $totalpages = ceil($total / $limit) ;

                $query = "SELECT * FROM users LIMIT $paginationStart,$limit";
               ...
               <div class="row">
                   <div class="col-sm-2">
                       <p class="text-center pt-5">
                                    <img class="rounded" src="<?php echo ("/test123/profile-pic/") . ($_SESSION['useremail']) . "display-picture.jpg"; ?>" width="150px" height="140px">
                                </p>
                   </div>
                   <div class="col-sm-8">
