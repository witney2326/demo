                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="card border">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="row row-cols-lg-auto g-3 align-items-center" novalidate action="basic_livelihood_cluster_training_filter2.php" method ="POST">
                                                        <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="card border border-primary">
                                                        <h5 class="my-0 text-default">SL Clusters in Region: <?php echo get_rname($link,$region);?></h5>
                                                    <div class="card-body">
