                                        ...
                                        <p class="mb-0">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="card border border-primary">
                                                    <div class="card-header bg-transparent border-primary">
                                                        <h5 class="my-0 text-primary"><i class="mdi mdi-bullseye-arrow me-3"></i>Clinics Conducted in <?php echo dis_name($link,$district); ?></h5>
                                                    </div>
                                                    <div class="card-body">
                                                    <h5 class="card-title mt-0"></h5>
                                                                ...
                                                                <tbody>
                                                                    <?Php
                                                                       $selectedDistrict = $_GET["district"];
                                                                        $query="select * from tblclinics where districtID ='$selectedDistrict'";
